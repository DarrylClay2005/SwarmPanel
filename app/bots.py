...
MUSIC_BOTS = [
    ...
    BotDefinition("strife", "Strife", "music", "STRIFE_DISCORD_TOKEN", "discord_music", "strife"),
    BotDefinition("lockhart", "Lockhart", "music", "LOCKHART_DISCORD_TOKEN", "discord_music", "lockhart"),
]
